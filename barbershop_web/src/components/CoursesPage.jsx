...
const CoursesPage = () => {
  ...
  return (
    ...
    >
      <div className='absolute top-1/3 left-1/2 transform -translate-x-1/2 container mx-auto px-4 lg:px-8 font-bold your-permanent-marker-text sm:top-1/2 sm:mt-4'>
